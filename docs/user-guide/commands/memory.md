...
|--------|-------------|---------|
| `--db PATH` | Path to the SQLite file | Auto-resolved (see [Storage](../concepts/memory.md#storage)) |
...
- [Memory concept guide](../concepts/memory.md) — data model, recall pipeline, bi-temporal semantics
- [Memory MCP Server](../../integrations/memory-mcp.md) — use memory from Claude Code / Cursor
